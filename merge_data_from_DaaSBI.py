...
current_file = 'data/20230917/dataset_multicity_20230917_1.csv'
append_file = 'data/20230917/dataset_multicity_20230917_2.csv'
...
merged_df.to_csv('data/dataset_multicity_20230917.csv', index=False)
